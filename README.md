...
- **HGraph** - `Hybrid Pulling/Pushing for I/O-Efficient Distributed and Iterative Graph Computing` (SIGMOD '16). [[paper]](https://dl.acm.org/citation.cfm?id=2882938), [[code]](https://github.com/HybridGraph/HGraph)
- **GraphH** - `GraphH: High Performance Big Graph Analytics in Small Clusters` (CLUSTER'17). [[paper]](https://ieeexplore.ieee.org/document/8048937), [[code]](https://github.com/cap-ntu/Graphee)(java)
